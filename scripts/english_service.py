...
def get_data():
    # Preamble logging.
    print('Beginning the automation script for updating data: English Service')
    t = dt.now()
    
    # GKI Salatiga channel's "English Service" playlist ID
    playlistId = 'PLtAv1OZRTdvLSP7qg6lCxvMX5hanq_va1'
    ...
    j['meta']['last-updated-item'] = 'yt-video/es'
    
    # Detecting which node is this playlist's
    node_title = 'English Service'
